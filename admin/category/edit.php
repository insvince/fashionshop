...
<body>
    <div id="main">
        ...
        <div id="container">
            <div class="content" style= "display: flex; flex-direction: column;min-height: 200px">
                <?php 
                ...
                ?>
                <form action="edit.php?this_id=<?=$this_id?>" method="post" style="text-align: center;">
                    <h3>Chỉnh sửa</h3>
                    
                    <input type="text" name="editname" style="padding: 10px 5px; border-radius: 5px; border: 1px solid;text-align: center;width: 30%" value= "<?=$row['name']?>">
                    <button type="submit" name="editbtn" style="padding: 10px 5px ; background-color: lightgreen;border: 1px solid; border-radius: 5px;">Sửa</button>
                </form>                
            </div>
        </div>
    </div>
